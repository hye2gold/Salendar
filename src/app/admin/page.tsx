            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  <p className={`text-sm font-semibold truncate ${selectedBrandId === brand.id ? 'text-white' : 'text-gray-900'}`}>
                    {brand.name}
                  </p>
                  <p className={`text-xs ${selectedBrandId === brand.id ? 'text-gray-200' : 'text-gray-500'}`}>
                    {brand.category}
                  </p>
                </div>
              </div>
        ...
        {selectedBrandId && brandDetail && (
          <div className="space-y-8">
                ...
                <div className="mt-2 flex flex-col md:flex-row md:items-center gap-4">
                  ...
                  >
                    {logoPreview ? (
                      ...
                      <img src={brandDetail.logo_url} alt={brandDetail.name} className="w-full h-full object-cover" />
                    ) : (
            ...
            <div className="border-t border-gray-100 pt-6 space-y-4">
              ...
              <form onSubmit={handleNewEvent} className="rounded-xl border border-dashed border-gray-200 p-4 space-y-3">
                ...
                <div className="grid md:grid-cols-2 gap-2">
                  {brandFavorites.map((fav) => (
                    <div key={fav.user_id} className="rounded-lg border border-gray-100 p-3">
                      ...
                      <p className="text-xs text-gray-400">찜한 날짜: {fav.created_at.slice(0, 10)}</p>
                    </div>
                  ))}
                </div>
              )}
